...
const SingleItem = ({ projectItems }) => {
    ...
    return (
        <section className="h-auto md:h-[100vh]" >
            <div className="overflow-hidden mt-40 flex items-center h-full w-full justify-center">
                <div className="max-w-6xl h-full  mt-28  md:mt-0 md:m-auto items-center justify-center flex-col md:flex-row flex gap-10">
                    <motion.div
                        style={{ opacity }}
                        ref={ref} className="flex-1 h-1/2 hover:rounded-lg md:overflow-hidden ">
