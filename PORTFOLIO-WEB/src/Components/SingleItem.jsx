    ...
    return (
        <section className="h-auto md:h-[100vh]  " >
            <div className="overflow-hidden  h-full w-full">
                <div className="max-w-6xl h-full p-6 md:p-10 m-auto items-center md:items-center justify-center flex-col md:flex-row flex md:gap-10">
                    <motion.div
                        ref={ref} className="flex-1 w-full max-h-80 md:h-1/2 hover:rounded-lg overflow-hidden ">
