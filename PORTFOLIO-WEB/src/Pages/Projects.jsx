...
const Projects = () => {
    ...
    return (
        <div className="portfolio relative " id="projects" ref={ref}>
            <div className="progress sticky top-0 left-0 z-10  md:pt-10 text-center text-2xl pt-[calc(100vh-100px)]   md:text-4xl text-white font-semibold md:text-orange-500 ">
